  ...
  context "outputing files" do
    {
      ...
      "javascript-codeceptjs" => {
        ...
        ["--split-scenarios", "--keep-filenames"] => [ "[features]",
                                                       "/Buy goods.feature",
                                                       "/Sell goods.feature",
                                                       "[step_definitions]",
                                                       "/step_definitions.js",
      ...
      "swift-xctest" => {
        ...
        ["--split-scenarios"]                    => [ "[tests]",
                                                      "/BuyPontarlierUITest.swift",
                                                      "/SellMontDOrUITest.swift",
                                                      "[actionwords]",
                                                      "/Actionwords.swift"
                                                    ],
        ["--with-folders"]                       => [ "[tests]",
                                                      "/GlobalTrades/BuyGoodsUITest.swift",
                                                      "/GlobalTrades/SellGoodsUITest.swift",
                                                      "[actionwords]",
                                                      "/Actionwords.swift"
                                                    ],
        ["--split-scenarios", "--with-folders"]  => [ "[tests]",
                                                      "/GlobalTrades/BuyGoods/BuyPontarlierUITest.swift",
                                                      "/GlobalTrades/SellGoods/SellMontDOrUITest.swift",
                                                      "[actionwords]",
                                                      "/Actionwords.swift"
                                                    ],
        ["--with-folders", "--keep-filenames", "--keep-foldernames"]  => [
                                                      "[tests]",
                                                      "/Global trades/Buy goodsUITest.swift",
                                                      "/Global trades/Sell goodsUITest.swift",
                                                      "[actionwords]",
                                                      "/Actionwords.swift"
                                                    ]
      },
